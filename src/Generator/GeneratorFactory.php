 ...
 * Generator Factory
 *
 * Provides a method to select the best available random generator.
 */
class GeneratorFactory
{
     ...
     *
     * @uses Generator\GeneratorInterface::getPriority() Used to sort the available generators from lowest to highest priority.
     */
     ...
     * @return void
     *
     * @uses Generator\GeneratorInterface Used to determine if a generator is supported by the system.
     */
